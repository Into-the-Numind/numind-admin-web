...
# Run from numind-admin-web repo root.
...
BUILD_REPO_PATH="repos/numind-admin-web"
...
echo "==============================================="
echo "  Release numind-admin-web -> $ENV"
...
echo
echo "==============================================="
echo "  ✅ Release complete: numind-admin-web -> $ENV ($EFFECTIVE_SHA)"
echo "==============================================="
