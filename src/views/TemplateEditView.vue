        ...
        <div v-else class="nodes-list">
          <div v-for="node in nodes" :key="node.id" class="node-item">
            ...
            <div class="node-item__actions">
              <AppButton size="sm" variant="ghost" @click="openNodeModal(node)"
                >编辑</AppButton
              >
              <button
          ...
          >
            ...
            <div class="form-grid">
              ...
              <div class="form-group">
                ...
                <AppInput
                  v-model="editingNode.sort as unknown as string"
                  type="number"
                  placeholder="排序"
                />
              </div>
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <AppInput
                  v-model="editingNode.model_name"
                  placeholder="gpt-4"
                />
              </div>
              <div class="form-group">
                ...
                <AppInput
                  v-model="editingNode.timeout_seconds as unknown as string"
                  type="number"
                  placeholder="60"
                />
              </div>
              ...
              <template v-if="!isNewNode && !changeApiKey">
                <div class="api-key-masked">
                  <span class="api-key-display">{{
                    maskApiKey(editingNode.api_key) || "已配置"
                  }}</span>
                  <AppButton
                    size="sm"
                    variant="ghost"
            ...
            <div class="modal-actions">
              <AppButton variant="secondary" @click="nodeModalVisible = false"
                >取消</AppButton
              >
              <AppButton
                variant="primary"
...
.node-item__sort {
  width: 28px;
  height: 28px;
  background: var(--tertiary-light, var(--surface));
  color: var(--tertiary);
  border-radius: var(--radius-sm);
  display: flex;
  align-items: center;
